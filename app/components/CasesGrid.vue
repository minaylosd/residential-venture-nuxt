    ...
    <section class="w-full bg-[#282828] py-10 lg:py-24">
        <div class="px-5 mx-auto lg:px-9 md:max-w-[1336px] w-full flex flex-col gap-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full">
                <NuxtLink v-for="(item, i) in cases" :key="i" :to="item.link" class="appear-up relative rounded-3xl overflow-hidden bg-[#3f454e]">
            ...
            <NuxtLink to="/cases" class="appear-up font-wide font-medium text-xl leading-6 text-brand w-fit mx-auto">Все кейсы</NuxtLink>
        </div>
    </section>
</template>
