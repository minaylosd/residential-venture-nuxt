<template>
    ...
    <section class="px-5 mx-auto lg:px-9 md:max-w-[1336px] w-full flex flex-col lg:gap-24 lg:py-24 gap-10 py-10">
        <p class="appear-up font-wide font-medium text-greytxt text-xl leading-6">
            ...
            отмены ещё до того, как гость её оформит.
        </p>
        ...
        <div>
            ...
            <p class="appear-up font-compact font-normal text-17 leading-6 text-greytxt">Data.Forecast — первая российская
                ...
                прогнозировать спрос, вероятность заезда, а также рекомендовать, как корректировать цены или когда
                запускать маркетинговую активность. </p>
        </div>
        ...
        <div>
            ...
            <p class="appear-up font-compact font-normal text-17 leading-6 text-greytxt">Каждое бронирование анализировалось
                ...
                использовались оценки Шэпли и другие методы интерпретации моделей.</p>
        </div>
        ...
        <div>
            ...
            <p class="appear-up font-compact font-normal text-17 leading-6 text-greytxt">AUC-метрика превысила 0.75 – это хороший
                ...
                составляет всего 12,7% от общего объема, но содержит 29% всех отмен. Работа с этим сегментом способна
                существенно снизить потери бизнеса. Например, за счет использования опережающих инструментов (отправка
                автоматической ссылки на предоплату, персонифицированная email-коммуникация, чат-бот, комплименты от
                отелей).</p>
        </div>
    ...
    <div class="flex flex-col lg:flex-row items-center gap-8 px-5 mx-auto lg:px-9 md:max-w-[1336px] w-full lg:py-24 py-10">
        <NuxtLink :to="prevId ? `/articles/${prevId}` : '#'" class="flex items-center lg:gap-8 gap-4"
        ...
        <NuxtLink :to="`/articles/${nextId}`" class="flex items-center lg:gap-8 gap-4">
            <span
